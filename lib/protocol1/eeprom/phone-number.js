/**
 * Protocol 1 EEPROM PhoneNumber implementation
 * Ported from Ruby TimexDatalinkClient::Protocol1::Eeprom::PhoneNumber
 */
...
class Protocol1PhoneNumber {
  ...
  numberWithTypePadded() {
    ...
    return numberWithType.padStart(Protocol1PhoneNumber.PHONE_DIGITS, ' ');
  }
...
export default Protocol1PhoneNumber;