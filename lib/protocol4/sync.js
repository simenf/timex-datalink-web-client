/**
 * Protocol 4 Sync packet implementation
 * Ported from Ruby TimexDatalinkClient::Protocol4::Sync
 */
...
class Protocol4Sync {
   ...
   */
  renderSync1() {
    return new Array(this.length).fill(Protocol4Sync.SYNC_1_BYTE[0]);
  }
   ...
   */
  renderSync2() {
    return new Array(Protocol4Sync.SYNC_2_LENGTH).fill(Protocol4Sync.SYNC_2_BYTE[0]);
  }
}

export default Protocol4Sync;